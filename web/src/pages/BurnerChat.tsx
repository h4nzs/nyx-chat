      ...
      <div className="flex h-full w-full items-center justify-center">
        <div className="animate-pulse flex flex-col items-center">
          ...
          <p className="text-text-secondary">
            Establishing Quantum-Secure Burner Session...
          </p>
        </div>
      </div>
    )
  ...
  return (
    <div className="flex flex-col h-full w-full bg-bg-main relative">
      ...
      <footer className="p-4 bg-bg-surface/50 border-t border-border">
        {isUploading && (
          <div className="text-xs text-accent mb-2 px-2 animate-pulse">
            Uploading encrypted attachment...
          </div>
        )}
        <form
          onSubmit={handleSend}
          className="flex gap-2 items-center bg-bg-main border border-border rounded-full pr-2 pl-1 py-1"
        >
          <button
            type="button"
