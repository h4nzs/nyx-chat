...
if (typeof window !== 'undefined') {
  ...
  setTimeout(() => {
    console.log(
      `%c${insignia}`,
      'color: #00ffcc; font-family: monospace; font-weight: bold; text-shadow: 0 0 5px #00ffcc;'
    )
    console.log(
      '%c⚠️ SECURITY WARNING: If you are not the admin, someone might be trying to execute a Self-XSS attack. If you are an auditor, welcome to the Enigma.',
...
if (!import.meta.env.VITE_APP_SECRET) {
  const errorMessage =
    'FATAL: VITE_APP_SECRET is not defined in the environment. This is required for key encryption.'
