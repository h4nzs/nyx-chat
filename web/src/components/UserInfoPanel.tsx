        ...
        <div className="space-y-6">
          <div className="bg-bg-surface rounded-xl shadow-neumorphic-convex p-6 text-center">
            {profile.avatarUrl ? (
              ...
              <DefaultAvatar
                name={profile.name}
                id={userId}
                className="w-24 h-24 mb-4 mx-auto bg-secondary"
              />
            )}
            ...
            {user.isVerified && (
              <span className="inline-block mt-1 px-2 py-0.5 rounded bg-accent/10 text-accent text-[10px] font-bold uppercase tracking-wider">
          ...
          <div className="bg-bg-surface rounded-xl shadow-neumorphic-convex p-4 space-y-2">
            <div className="flex items-center justify-between p-3 rounded-lg bg-bg-surface shadow-neumorphic-pressed">
              ...
              >
                <div
                  className={`absolute top-1 left-1 w-4 h-4 rounded-full bg-white transition-transform ${isPqDr ? 'translate-x-6' : ''}`}
                />
              </button>
            </div>
            <button
