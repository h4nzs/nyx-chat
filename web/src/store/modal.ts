...
export interface ModalState {
  ...
  showPasswordPrompt: (
    callback: (password: PasswordSubmitResult) => void
  ) => void
...
export const useModalStore = create<ModalState>()((set) => ({
  ...
  openProfileModal: (userId) =>
    set({ isProfileModalOpen: true, profileUserId: userId }),
  closeProfileModal: () =>
    set({ isProfileModalOpen: false, profileUserId: null }),
  showPasswordPrompt: (callback) =>
    set({ isPasswordPromptOpen: true, onPasswordSubmit: callback }),
