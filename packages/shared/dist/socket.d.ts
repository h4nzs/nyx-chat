...
export interface ServerToClientEvents {
    ...
    "message:new": (message: RawServerMessage) => void;
    "message:updated": (message: Partial<RawServerMessage> & {
        id: string;
    }) => void;
    ...
    "message:viewed": (payload: {
        messageId: string;
        conversationId: string;
    }) => void;
    "messages:expired": (payload: {
        messageIds: string[];
    }) => void;
    ...
    "reaction:deleted": (payload: {
        conversationId: string;
        messageId: string;
        reactionId: string;
    }) => void;
    "conversation:new": (conversation: Conversation) => void;
    "conversation:updated": (conversation: Partial<Conversation> & {
        id: string;
    }) => void;
    "conversation:deleted": (payload: {
        id: string;
    }) => void;
    "conversation:participants_added": (payload: {
        conversationId: string;
        newParticipants: {
            id: string;
            role: 'ADMIN' | 'MEMBER';
    ...
    "conversation:participant_removed": (payload: {
        conversationId: string;
        userId: string;
    }) => void;
    "conversation:participant_updated": (payload: {
        conversationId: string;
        userId: string;
        role: string;
    }) => void;
    ...
    "group:key_request_failed": (payload: {
        conversationId: string;
        reason: string;
    }) => void;
    "session:request_key_failed": (payload: {
        sessionId: string;
        targetId: string;
        reason: string;
    }) => void;
    ...
    'user:identity_changed': (data: {
        userId: string;
        name?: string;
    }) => void;
    "group:participants_changed": (payload: {
        conversationId: string;
    }) => void;
    ...
    "migration:ack": (payload: {
        roomId: string;
        success: boolean;
    }) => void;
    'message:deleted_remotely': (payload: {
        messageId: string;
        conversationId: string;
        deletedBy: string;
    }) => void;
    "burner:receive": (payload: {
        roomId: string;
        ciphertext: string;
    }) => void;
    "burner:terminated": (payload: {
        roomId: string;
    }) => void;
}
export interface ClientToServerEvents {
    ...
    "user:active": () => void;
    "user:away": () => void;
    "message:send": (message: MessageSendPayload, callback: (res: {
        ok: boolean;
    ...
    "session:request_missing": (payload: {
        conversationId: string;
        sessionId: string;
    }) => void;
    "session:fulfill_response": (payload: KeyFulfillmentPayload) => void;
    "messages:distribute_keys": (payload: DistributeKeysPayload, callback: (res: {
        ok: boolean;
    }) => void) => void;
    ...
    "auth:request_linking_qr": (payload: {
        publicKey: string;
    }, callback: (res: {
        ok: boolean;
        qrData?: string;
    ...
    'message:unsend': (payload: {
        messageId: string;
        conversationId: string;
    }) => void;
    'message:view_once_opened': (payload: {
        messageId: string;
        conversationId: string;
    }) => void;
    "burner:send": (payload: {
    ...
    "burner:reply": (payload: {
        roomId: string;
        ciphertext: string;
    }) => void;
    "burner:destroy": (payload: {
        roomId: string;
        hostUserId?: string;
    }) => void;
}
